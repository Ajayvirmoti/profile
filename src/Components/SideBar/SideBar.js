...
const SideBar = () =>{
    ...
    return(
        <div className="side-bar">
            <div className="logo"><FaGithub onClick={clickHandler_git}/></div>
            <div className="logo"><TbBrandLeetcode onClick={clickHandler_lc}/></div>
            <div className="logo"><RiLinkedinLine onClick={clickHandler_ln}/></div>
            <div className="logo"><CiInstagram onClick={clickHandler_insta}/></div>
        </div>
    )
